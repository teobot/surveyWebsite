...
<div class="container" style="background-color: paleturquoise; border-left: 6px solid mediumturquoise;">    
    ...
    <div class="row">
        ...
        <div class="col">
            <ul class="list-group">
                <li class="list-group-item"><h5 class="mb-1">Negatives</h5></li>
                <li class="list-group-item">Steep learning curve.</li>
                <li class="list-group-item">lot's of paid features.</li> 
                <li class="list-group-item">Complex and confusing layout.</li>
            </ul>
        </div>
    </div>
    <hr>
